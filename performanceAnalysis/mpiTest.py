...
process_count = 8  # Number of processes for MPI
...
output_csv = "mpi_benchmark_results.csv"  # Updated output CSV filename
...
for length, word in words_by_length.items():
    print(f"Running MPI tests for length {length} with {process_count} processes...")
    runtimes = []
...
print("MPI benchmarking complete. Results saved to mpi_benchmark_results.csv.")
